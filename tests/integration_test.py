...
def test_find_cheaper_products_valid_start_wb():
    result = find_cheaper_products(
        "https://www.wildberries.ru/catalog/180601137/detail.aspx",
        "Не установлен",
        False,
    )
    assert len(result) > 0
...
def test_find_cheaper_products_valid_start_ozon():
    result = find_cheaper_products(
        "https://www.ozon.ru/product/io-by-red-square-naushniki-provodnye-s-mikrofonom-io-graphite-se-3-5-mm-temno-siniy-1758244283/?campaignId=514",
        "Не установлен",
        False,
    )
    assert len(result) > 0
...
def test_find_cheaper_products_invalid():
    result = find_cheaper_products(
        "https://ru.stackoverflow.com/questions/1438418/aiogram-%D0%BD%D0%B0-inline-%D0%BA%D0%BD%D0%BE%D0%BF%D0%BA%D1%83-%D0%BF%D0%BE%D0%B2%D0%B5%D1%81%D0%B8%D1%82%D1%8C-url-%D0%B8-%D0%BE%D0%B1%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%87%D0%B8%D0%BA-%D0%B4%D0%BB%D1%8F-%D1%81%D1%82%D0%B0%D1%82%D0%B8%D1%81%D1%82%D0%B8%D0%BA%D0%B8",
        "Не установлен",
        False,
    )
